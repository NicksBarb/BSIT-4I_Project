...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Barangay 10M MIS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="assets\AdminLTE-3.2.0\dist/img/TF.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Secretary Barbara</a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="users" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Users of Barangay MIS
              </p>
            </a>
          </li>

          <li class="nav-item">
            <a href="acc_settings" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Account Settings
              </p>
...
<div class="content-wrapper">
              ...
              <div class="card-body">
                <ul class="todo-list" data-widget="todo-list">
                  <li>
                    ...
                    <!-- todo text -->
                    <span class="text">Daily Meeting</span>
                    <!-- Emphasis label -->
                    <small class="badge badge-danger"><i class="far fa-clock"></i> 120 mins</small>
                  ...
                  <li>
                    ...
                    <span class="text">Make the Barangay Certificate</span>
                    <small class="badge badge-info"><i class="far fa-user"></i> 4 persons</small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
                  ...
                  <li>
                    ...
                    <span class="text">Make the Barangay Bussiness Certificate</span>
                    <small class="badge badge-warning"><i class="far fa-store"></i> 5 Businesses</small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
                  ...
                  <li>
                    ...
                    <span class="text">Sign Reports</span>
                    <small class="badge badge-success"><i class="far fa-signature"></i> 5 Reports</small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
                  ...
                  <li>
                    ...
                    <span class="text">Daily Cleaning</span>
                    <small class="badge badge-primary"><i class="far fa-clock"></i> 5 hours</small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="dashboard">Barangay 10M MIS</a>.</strong>
    All rights reserved.
